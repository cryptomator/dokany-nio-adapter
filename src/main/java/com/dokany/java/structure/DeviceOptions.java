...
public class DeviceOptions extends Structure implements Structure.ByReference {
	...
	public DeviceOptions(final Path mountPoint, final short threadCount, final EnumIntegerSet<DokanOption> dokanOptions, final String uncName, final long timeout, final long allocationUnitSize, final long sectorSize) {
		this.mountPointPath = mountPoint;
		MountPoint = new WString(mountPoint.toString());
