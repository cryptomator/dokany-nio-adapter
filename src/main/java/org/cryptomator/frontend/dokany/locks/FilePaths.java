...
public class FilePaths {
	...
	static List<String> toComponents(String pathRelativeToRoot) {
	...
	static String toPath(List<String> pathComponents) {
		return PATH_JOINER.join(pathComponents);
	}

	static List<String> parentPathComponents(List<String> pathComponents) {
